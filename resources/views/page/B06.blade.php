...
<div id=ken>
  ...
  <option  value="1" {{isset($request->course) && $request->course==1 ?'selected': null}}>フルコース</option>
  <option  value="2" {{isset($request->course) && $request->course==2 ?'selected': null}}>ショートコース</option>
  </select>
  <button type="submit"class="button">検索</button>

  </form>
<form>
<button type="submit"class="rebutton" onclick="location.href='/B006'">リセット</button>
</form>
</div>
